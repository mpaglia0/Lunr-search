...
that can be used by LUNR search JavaScript

Original Copyright (c) Talha Mansoor (Tipuesearch)
Amended for LUNR by Maurizio Paglia
"""
...
class Search_index_JSON_Generator(object):
    ...
    def generate_output(self, writer):
        path = os.path.join(self.output_path, 'lunr_index.js')
        ...
        root_node_js = 'var lunr_index = ' + json.dumps(root_node, separators=(', ', ': '), ensure_ascii=False) + ';'
...
def get_generators(generators):
    return Search_index_JSON_Generator
